        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form id="frmNewCreditor" name="frmNewCreditor" method="post" action="{{ url('/creditor/store') }}" role="form">
                        ...
                        <div class="box-body">
                            ...
                            <div class="tab-content clearfix">
                                <div class="tab-pane active" id="1a" style="padding: 10px;">
                                    <div class="col-md-6">
                                        <div class="form-group" ng-class="{ 'has-error' : frmNewCreditor.prename_id.$invalid}">
                                            ...
                                            <div class="help-block" ng-show="frmNewCreditor.prename_id.$error.required">
                                                กรุณาเลือกคำนำหน้า
                                            </div>
                                        </div>
