<html>
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1 style="margin: 0px;">ใบลากิจ ลาคลอด ลากิจส่วนตัว</h1>
            </div>
            <div class="content">
                            ...
                            <div class="leave-stat">
                                ...
                                <table style="width: 90%;" class="table" border="1">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            {{ ($leave->leave_type == '1') ? $leave->leave_days : '' }}
                                        </td>
                                        <td style="text-align: center;">
                                            {{ ($leave->leave_type == '1') ? (float)$histories->ill_days + (float)$leave->leave_days : (float)$histories->ill_days }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>กิจส่วนตัว</td>
                                        ...
                                        <td style="text-align: center;">
                                            {{ ($leave->leave_type == '2') ? $leave->leave_days : '' }}
                                        </td>
                                        <td style="text-align: center;">
                                            {{ ($leave->leave_type == '2') ? (float)$histories->per_days + (float)$leave->leave_days : (float)$histories->per_days }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>คลอดบุตร</td>
                                        ...
                                        <td style="text-align: center;">
                                            {{ ($leave->leave_type == '3') ? $leave->leave_days : '' }}
                                        </td>
                                        <td style="text-align: center;">
