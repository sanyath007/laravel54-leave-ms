...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">รายการซ่อมครุภัณฑ์</li>
        </ol>
    </section>

    <!-- Main content -->
    <section class="content" ng-controller="reparationCtrl" ng-init="getData()">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form id="frmSearch" name="frmSearch" role="form">
                        ...
                        <div class="box-footer">
                            <a href="{{ url('/reparation/add') }}" class="btn btn-primary">
                                เพิ่มรายการซ่อม
                            </a>
                        </div>
                    </form>
                ...
                <div class="box">
                    <div class="box-header with-border">
                      <h3 class="box-title">รายการซ่อมครุภัณฑ์</h3>
                    </div><!-- /.box-header -->
                        ...
                        <table class="table table-bordered table-striped" style="font-size: 14px;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 8%; text-align: center;">รหัสรายการ</th>
                                    <th style="width: 10%; text-align: center;">วันส่งซ่อม</th>
                                    <th style="text-align: left;">ครุภัณฑ์</th>
                                    <th style="width: 20%; text-align: left;">อาการเสีย</th>
                                    <th style="width: 25%; text-align: left;">รายละเอียดการซ่อม</th>
                                    <th style="width: 8%; text-align: right;">ค่าซ่อม</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr ng-repeat="(index, reparation) in reparations">
                                    <td style="text-align: center;">@{{ index+pager.from }}</td>
                                    <td style="text-align: center;">@{{ reparation.reparation_id }}</td>
                                    <td style="text-align: center;">@{{ reparation.reparation_date | thdate }}</td>            
                                    <td style="text-align: left;">
                                        @{{ reparation.asset.asset_no }}
                                        @{{ reparation.asset.asset_name }}
                                    </td>
                                    <td style="text-align: left;">@{{ reparation.reparation_cause }}</td>
                                    <td style="text-align: left;">@{{ reparation.reparation_detail }}</td>
                                    <td style="text-align: right;">@{{ reparation.reparation_price | currency:"":0 }}</td>             
                                </tr>
                            </tbody>
                        </table>
                    </div><!-- /.box-body -->
